									...
									<figure>
										<a class="aa-product-img"
											...
											src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" --%>
											 <img src="${pageContext.request.contextPath}/view/client/assets/images/${product.image_link}"/> 
											<%-- alt="${product.name}"> --%></a>
                ...
                <ul>
                 <c:forEach items="${productlist}" var="product" end="2">
                  <li>
                    ...
                    <img alt="img" src="${pageContext.request.contextPath}/view/client/assets/images/${product.image_link}"></a>
