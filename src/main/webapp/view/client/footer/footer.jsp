            ...
            <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                    ...
                    <li><p style="color:#888; text-align: justify; width: 95%"> Chúng tôi luôn đặt tiêu chí về chất lượng và uy tín lên hàng đầu.</p></li>
                  ...
                  <div class="aa-footer-widget">
                    ...
                    <address>
                     ...
                     <!--  <p><span class="fa fa-phone"></span>037.7026.186</p> -->
                      <p><span class="fa fa-envelope"></span>BLHTeam@gmail.com</p>
                    </address>
