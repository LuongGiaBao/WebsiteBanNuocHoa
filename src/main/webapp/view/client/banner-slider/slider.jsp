      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/Banner1.jpg" alt="Men slide img" />
              </div>
              <div class="seq-title">
               <span data-seq>Giảm giá lên đến 50%</span>                
                <h2 data-seq>Black Friday tặng Voucher 100.000 VND</h2>                
                <p data-seq>Cho Khách hàng thân thiết</p><br/>
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/banner2.jpg" alt="Wristwatch slide img" />
              </div>
              <div class="seq-title">
                <span data-seq>Nước Hoa chính hãng team Perfume</span>                
                <h2 data-seq>Siêu Sale </h2>                
